...
const OurWork = () => {
    ...
    return (
        <div id="ourWork" className="bgColors ourWork-container" data-testid="section-container">
            ...
            <div id="ourWorkText" className="text_rules _3bcaz" data-testid="richTextElement" data-angle="0" data-angle-style-location="style" data-screen-in-hide="done" style={{visibility: "inherit"}}>
                <h1 className="font_5">
        ...
        //     <div id="comp-ka50ygty1_r_comp-k9ttd4hy2" className="text_rules _3bcaz" data-testid="richTextElement" data-angle="0" data-angle-style-location="style" data-screen-in-hide="done" style={{visibility: "inherit"}}>
        //         <h1 className="font_5">
        //             <span style={{fontWeight:"400"}}>Explore our work</span></h1></div>
