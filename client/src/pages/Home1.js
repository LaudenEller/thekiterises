const Home1 = () => {
    ...
    return (
        ...
        <div id="PAGE_SECTIONSnvemy" className="xJqji">
            <div className="comp-ka50ygty1">
                <section id="comp-ka50ygty1_r_comp-k9ttd4g7">
                    <div id="comp-ka50ygty1_r_comp-k9ttd4hy2" className="_1Q9if _3bcaz" style={{ opacity: 0 }}>
                        <h1 className="font_5">
                            <span style={{ fontWeight: 400 }}>Explore our work</span>
                        </h1>
                    </div>
                    <div className="_3vc75" id="comp-ka50ygty1_r_comp-k9ttd4hw" aria-disabled="false" style={{ opacity: 0 }}>
                        <a href="https://www.thekiterises.com/ourwork" target="_self" className="_3wqEk" aria-disabled="false">
                            ::before
                            <span className="_10nnq">Explore</span>
                            ::after
                        </a>
                    </div>
                </section>
            </div>
            <section id="comp-l2lk0o9n" className="_3uJnK comp-l2lk0o9n-container undefined">
                <div id="bgLayers_comp-l2lk0o9n" data-hook="bgLayers" className="_3wnIc">
                    ...
                    <div id="bgMedia_comp-l2lk0o9n" className="_2GUhU"></div>
                </div>
                <div id="comp-l2lk0o9u" className="_3Fes4 comp-l2lk0o9u-container">
                    ...
                    <div id="comp-l2lk0oa9" className="_3Fes4 comp-l2lk0oa9-container">
                        <div className="_2l-6d"></div>
                        <div id="comp-l2lk0oae" className="_1Q9if _3bcaz" data-testid="richTextElement">
                            <p className="font_7">
                        ...
                        <div id="comp-l2lk0oam" className="_1Q9if _3bcaz" data-testid="richTextElement">
                            <p className="font_8">Copyright © The Kite Rises 2022&nbsp;| All Rights Reserved.</p></div></div>
                </div>
            </section>
        </div>
